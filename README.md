...
Reumatoïde artritis (RA) treft wereldwijd ongeveer 1% van de bevolking en vormt daarmee een aanzienlijke maatschappelijke en medische belasting. In Nederland gaat het om circa 280.000 patiënten en jaarlijks ruim 11.000 nieuwe diagnoses [(Volksgezondheid en Zorg, 2024)](https://www.vzinfo.nl/reumato%C3%AFde-artritis). De oorzaak is nog niet volledig opgehelderd, maar genetische aanleg, omgevingsfactoren en immuunontregeling spelen waarschijnlijk een belangrijke rol [(Gabriel, 2001)](https://doi.org/10.1016/s0889-857x(05)70201-5). Een kenmerkend verschijnsel is synovitis, een ontsteking van het synovium die kan leiden tot gewrichtsschade en functieverlies [(Radu & Bungau, 2021)](https://doi.org/10.3390/cells10112857). Hoewel behandelingen ziekteactiviteit kunnen onderdrukken, blijft genezing uit en is inzicht in moleculaire mechanismen belangrijk. [(Majithia & Geraci, 2007)](https://doi.org/10.1016/j.amjmed.2007.04.005).

Een belangrijk probleem bij RA is dat de moleculaire mechanismen die leiden tot chronische ontsteking en gewrichtsschade nog niet volledig worden begrepen. RNA-sequencing (RNA-seq) wordt daarom steeds vaker ingezet om veranderingen in genexpressie te onderzoeken. Deze techniek brengt genexpressieprofielen in kaart en identificeert differentieel tot expressie gebrachte genen, biologische processen en signaalroutes. Eerder RNA-seq-onderzoek aan synoviaal weefsel van RA-patiënten liet al zien dat differentieel tot expressie gebrachte genen sterk verrijkt zijn voor immuun- en ontstekingsgerelateerde processen, waaronder cytokine-receptorinteracties en chemokinesignalering [(Zhang et al., 2022)](https://doi.org/10.3389/fmed.2022.799440). Dit type onderzoek biedt dus een concreet aanknopingspunt om de moleculaire basis van RA verder te ontrafelen.
