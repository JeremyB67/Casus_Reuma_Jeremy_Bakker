...
Reumatoïde artritis (RA) treft wereldwijd ongeveer 1% van de bevolking en vormt daarmee een aanzienlijke maatschappelijke en medische belasting. In Nederland gaat het om circa 280.000 patiënten en jaarlijks ruim 11.000 nieuwe diagnoses [(Volksgezondheid en Zorg, 2024)](https://www.vzinfo.nl/reumato%C3%AFde-artritis). De exacte oorzaak van de ziekte is nog niet volledig opgehelderd, maar er wordt aangenomen dat een combinatie van genetische aanleg, omgevingsfactoren en ontregeling van het immuunsysteem een belangrijke rol speelt [(Gabriel, 2001)](https://doi.org/10.1016/s0889-857x(05)70201-5). Een kenmerkend verschijnsel van RA is synovitis, een ontsteking van het gewrichtsslijmvlies (synovium), die kan leiden tot progressieve gewrichtsschade en functieverlies [(Radu & Bungau, 2021)](https://doi.org/10.3390/cells10112857). Hoewel huidige behandelingen de ziekteactiviteit vaak effectief kunnen onderdrukken, blijft volledige genezing uit en blijft inzicht in de onderliggende moleculaire mechanismen belangrijk. [(Majithia & Geraci, 2007)](https://doi.org/10.1016/j.amjmed.2007.04.005).

Een belangrijk probleem bij RA is dat de moleculaire mechanismen die leiden tot chronische ontsteking en gewrichtsschade nog niet volledig worden begrepen. RNA-sequencing (RNA-seq) wordt daarom steeds vaker ingezet om veranderingen in genexpressie te onderzoeken. Deze techniek brengt het genexpressieprofiel van een weefsel in kaart en maakt het mogelijk om te bepalen welke genen differentieel tot expressie komen en welke biologische processen en signaalroutes hierbij betrokken zijn. Eerder RNA-seq-onderzoek aan synoviaal weefsel van RA-patiënten liet al zien dat differentieel tot expressie gebrachte genen sterk verrijkt zijn voor immuun- en ontstekingsgerelateerde processen, waaronder cytokine-receptorinteracties en chemokinesignalering [(Zhang et al., 2022)](https://doi.org/10.3389/fmed.2022.799440). Dit type onderzoek biedt dus een concreet aanknopingspunt om de moleculaire basis van RA verder te ontrafelen.
...
Voor deze analyse wordt gebruikgemaakt van een publieke RNA-seq dataset afkomstig uit een eerder onderzoek van [Platzer et al. (2019)](https://doi.org/10.1371/journal.pone.0219698). De dataset bestaat uit acht synoviumbiopten, waarvan vier afkomstig zijn van patiënten met gevestigde RA (ziekteduur >12 maanden) en vier van personen zonder RA. De biopten worden verkregen uit het synovium, het gewrichtsslijmvlies dat een centrale rol speelt in de pathologie van RA. Alle RA-patiënten zijn positief voor anti-cyclische gecitrullineerde peptiden (ACPA), terwijl de controlegroep ACPA-negatief is. Zie <strong>[Tabel 1]</strong> voor overzicht samples [Platzer et al. (2019)](https://doi.org/10.1371/journal.pone.0219698).

De bio-informatische analyse wordt uitgevoerd in R Studio (V4.5.2). Sequencing reads worden gemapt tegen het humane referentiegenoom GRCh38.p14 [(NCBI, 2026)](https://www.ncbi.nlm.nih.gov/datasets/genome/GCF_000001405.40/) met behulp van het Rsubread package (V2.24.0)[(Liao et al., 2019)](https://doi.org/10.1093/nar/gkz114). Vervolgens worden reads per gen gekwantificeerd met featureCounts. Differentiële genexpressie tussen de RA- en controlegroep wordt bepaald met DESeq2 (V1.50.2)[(Love et al., 2014)](https://doi.org/10.1186/s13059-014-0550-8). Significant gereguleerde genen worden verder onderzocht met Gene Ontology (GO) [(Carbon et al., 2021)](https://doi.org/10.1093/nar/gkaa1113) en KEGG-pathwayanalyses [(Kanehisa et al., 2023)](https://doi.org/10.1093/nar/gkac963), met behulp van clusterProfiler (V4.18.4)[(Yu et al., 2012)](https://doi.org/10.1089/omi.2011.0118). Waarna relevante pathways worden gevisualiseerd met Pathview (V1.50.0)[(Luo & Brouwer, 2013)](https://doi.org/10.1093/bioinformatics/btt285). Zie <strong>[Figuur 1]</strong>.
<br>
<table>
...
<p>
Rijksinstituut voor Volksgezondheid en Milieu. (2024).
<i>Reumatoïde artritis (RA)</i>.
Volksgezondheid en Zorg.
<a href="https://www.vzinfo.nl/reumato%C3%AFde-artritis" target="_blank">
https://www.vzinfo.nl/reumato%C3%AFde-artritis
</a>
</p>
